...
const init = () => {
    hideAllTabBody();
    //hideAllTabHead();
    document.querySelector('.app-body-content-thumbnail').innerHTML = ''; // Clear the thumbnail
    document.querySelector('.name').textContent = ''; // Clear the superhero name
    document.querySelector('.name').textContent = 'Find Your Superhero';
}*/
